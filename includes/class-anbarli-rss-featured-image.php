<?php
/**
 * Anbarli RSS Featured Image class.
 *
...
if ( ! class_exists( 'Anbarli_RSS_Featured_Image' ) ) {
	...
	final class Anbarli_RSS_Featured_Image {
		...
		public function load_textdomain() {
			load_plugin_textdomain( 'anbarli-rss-featured-image', false, dirname( plugin_basename( ANBARLI_RSS_FEATURED_IMAGE_FILE ) ) . '/languages' );
		}
